...
class Fraction:
    ...
    def as_mixed_number(self):
        ...
        return f"{integer_part} + {remainder}/{self._denominator}" if integer_part != 0 else f"{remainder}/{self._denominator}"
    ...
    def __add__(self, other):
        ...
        """
        num = self._numerator * other.denominator + other.numerator * self._denominator
    ...
    def __mul__(self, other):
        ...
        """
        num = self._numerator * other.numerator
        den = self._denominator * other.denominator
        return Fraction(num, den)
    ...
    def __truediv__(self, other):
        ...
        num = self._numerator * other.denominator
        den = self._denominator * other.numerator
        return Fraction(num, den)
